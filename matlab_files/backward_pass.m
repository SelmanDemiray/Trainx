function [dL_by_dW0,dL_by_dW1,dL_by_db0,dL_by_db1] = backward_pass(images,labels,r0,r1,W0,W1,b0,b1)
...
if ~isnumeric(images) || ~all(size(images) == [784 size(r0,2)])
...
dL_by_dr1 = r1-labels; % TO-DO: CALCULATE THIS GRADIENT

% calculate the gradient of the output layer activity with respect to the output layer input
dr1_by_dx1 = r1.*(1-r1); % TO-DO: CALCULATE THIS GRADIENT
...
dL_by_dx0 = dL_by_dr0.*dr0_by_dx0.'; % TO-DO: CALCULATE THIS GRADIENT

% calculate the gradient of the hidden layer input with respect to the hidden layer weights
dx0_by_dW0 = images; % TO-DO: CALCULATE THIS GRADIENT
